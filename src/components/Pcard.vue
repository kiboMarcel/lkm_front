...
<style>
 ...
 .main_nav ul.top_tools > li a {
  color: #111;
}
 .main_nav ul.top_tools > li a:hover {
  color: #004dda;
}
 .main_nav ul.top_tools > li a.btn_cat_mob .hamburger-inner,
 .main_nav ul.top_tools > li a.btn_cat_mob .hamburger-inner::before,
 .main_nav ul.top_tools > li a.btn_cat_mob .hamburger-inner::after {
  background-color: #111;
}
 .main_nav ul.top_tools > li a.btn_cat_mob:hover .hamburger-inner,
 .main_nav ul.top_tools > li a.btn_cat_mob:hover .hamburger-inner::before,
 .main_nav ul.top_tools > li a.btn_cat_mob:hover .hamburger-inner::after {
  background-color: #004dda;
}
 .main_nav ul.top_tools > li a.cart_bt strong {
  background-color: #083487;
  color: #fff !important;
}
 .main_nav ul.top_tools > li .dropdown-cart .dropdown-menu,
 .main_nav ul.top_tools > li .dropdown-access .dropdown-menu {
  border-top: 2px solid #004dda;
  margin-top: 0;
}
 .main_nav ul.top_tools > li .dropdown-cart .dropdown-menu:before,
 .main_nav ul.top_tools > li .dropdown-access .dropdown-menu:before {
  border-bottom-color: #004dda;
}
 .main_nav ul.top_tools > li .dropdown-cart:hover > a,  .main_nav ul.top_tools > li .dropdown-access:hover > a {
  color: #004dda;
}
</style>